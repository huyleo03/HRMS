      ...
      <div className="nav-menu">
        {menuItems.map((item, index) => (
          <div key={index} className="nav-item-container">
            <div 
              className={`nav-item-background ${isActiveRoute(item.path) ? 'active' : ''}`} 
            />
            <div 
