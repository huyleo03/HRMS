      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          <path
            ...
            stroke={activeTab === 'documents' ? '#7152F3' : '#16151C'}
            strokeWidth="1.5"
                ...
                <div className="documents-info">
                  <div className="documents-placeholder">
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M12 16C12 10.4772 16.4772 6 22 6H38.6863C40.8154 6 42.8579 6.84572 44.3431 8.33097L51.6569 15.6447C53.1421 17.1299 54 19.1724 54 21.3137V48C54 53.5228 49.5228 58 44 58H22C16.4772 58 12 53.5228 12 48V16Z"
                        stroke="#A2A1A8" strokeWidth="2" strokeLinejoin="round"/>
