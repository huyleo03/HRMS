...
export const getTodayStatus = async () => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.TODAY_STATUS, {
      method: "GET",
    });
  } catch (error) {
...
export const getMyHistory = async (params = {}) => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.MY_HISTORY, {
      method: "GET",
      params: params,
    });
  } catch (error) {
...
export const getDepartmentOverview = async (params = {}) => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.DEPARTMENT_ATTENDANCE, {
      method: "GET",
      params: params,
    });
  } catch (error) {
...
export const getDepartmentReport = async (params = {}) => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.DEPARTMENT_REPORT, {
      method: "GET",
      params: params,
    });
  } catch (error) {
...
export const getAllAttendance = async (params = {}) => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.ALL_ATTENDANCE, {
      method: "GET",
      params: params,
    });
  } catch (error) {
...
export const getCompanyReport = async (params = {}) => {
  try {
    return await apiCall(API_CONFIG.ENDPOINTS.COMPANY_REPORT, {
      method: "GET",
      params: params,
    });
  } catch (error) {
